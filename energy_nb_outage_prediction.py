...
# Database
connection_string = f"postgresql://{dbutils.secrets.get('db', 'outage_ops_svc_username')}:{dbutils.secrets.get('db', 'outage_ops_svc_password')}@outage-db-prod.energy.internal:5432/energy_outage_db"
